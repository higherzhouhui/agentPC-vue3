<template>
  <div class="user-list-wrap">
    <div class="titles">{{ $t('CUST.translate227') }}</div>
    <div class="displayf">
...
import { agentGameStatis } from '@/api/reportForm/reportForm'
...
const state = reactive({
  ...
  columns: [
    ...
    { prop: 'totalBetPerson', label: t('CUST.translate232'), width: 190 },
...
const handleDownload = async () => {
  ...
  await exportReportTable(state.formInline, t('CUST.translate227'), 'agentGameStatis')
