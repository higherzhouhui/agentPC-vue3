<template>
  <div id="tags-view-container" class="tags-view-container">
    <el-scrollbar ref="scrollPaneEl" wrap-class="tags-view-wrapper" class="scroll-container" @scroll="handleScroll"
      @wheel.prevent="scrollHandle">
      <!--      :tagRefList="tagRefList" -->
      <router-link v-for="(tag, index) in set.visitedViews" :ref="el => setTagRef(index, el)" :key="tag.path"
